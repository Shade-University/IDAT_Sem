...
public class User {
    ...
    public User(String firstName, String lastName, String email, USER_TYPE type, String password) {
    ...
    public User(int id, String firstName, String lastName, String email, Date dateCreated, USER_TYPE type) {
        this.id = id;
